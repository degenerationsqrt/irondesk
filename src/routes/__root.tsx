  ...
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      {
        name: "description",
        content:
          "IronDesk is a training intelligence command center for serious athletes: strength, conditioning, recovery, nutrition and coaching in one dashboard.",
      },
      { property: "og:title", content: "IronDesk — Training Intelligence Platform" },
      {
        property: "og:description",
        content: "Strength, conditioning, recovery and nutrition analytics for serious athletes.",
      },
